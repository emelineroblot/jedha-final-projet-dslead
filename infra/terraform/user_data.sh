...
mkdir -p $APP/data/processed $APP/reports $APP/airflow-logs
...
chown -R 50000:0 $APP/src $APP/data $APP/reports $APP/airflow-logs
chmod -R g+rwX $APP/src $APP/data $APP/reports $APP/airflow-logs
